  ...
  return (
    <div style={styles.container}>
      <div style={styles.card}>
        ...
        <p style={styles.paragraph}>Thank you for your booking. You're one step closer to success!<br/>Please Upload YOur CV to Your Drive Before Scheduling Your Appointment</p>
